...
```{r}
data14 <- read_excel("2014_manhattan.xls",  col_names = TRUE, sheet = "Manhattan", skip = 4)
data15 <- read_excel("2015_manhattan.xls",  col_names = TRUE, sheet = "Manhattan", skip = 4)
data16 <- read_excel("2016_manhattan.xls",  col_names = TRUE, sheet = "Manhattan", skip = 4)
